...
const TREE_TYPES = {
    ...
    "Holly": {
        canopyArr: [
            {color: "#a5e5da", ycm: 0.9, sm: 0.8, xm: 0.6, zm: 0.6},
            {color: "#86f1d6", ycm: 0.9, sm: 0.8, xm: 0.6, zm: 0.6},
            {color: "#5144ad", ycm: 0.8, sm: 0.2, xm: 12, zm: -12},
            {color: "#5144ad", ycm: 0.5, sm: 0.2, xm: 12, zm: 0},
            {color: "#5144ad", ycm: 0.3, sm: 0.2, xm: 12, zm: 12},
        ],
        minTreeHeight: 3,
        maxTreeHeight: 8,
        radiusTrunkBase: 0.2,
